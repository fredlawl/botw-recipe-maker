...
describe("Recipe.craft()", () => {
	...
	test("given sufficient inventory, recipe is crafted", () => {
		const inventory: ItemStack<Ingredient>[] = [
			new ItemStack(new Ingredient("Apple", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 10),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 1),
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 20),
		];

		const strawBerryBananaPopsicle = new Recipe("Strawberry Banana Popsicle", [
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 3),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 1),
		]);
	...
	test("given insufficient inventory the recipe is not crafted", () => {
		...
		const strawBerryBananaPopsicle = new Recipe("Strawberry Banana Popsicle", [
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 3),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT, EffectType.NONE, StatsType.NONE), 3),
		]);
