...
describe("Recipe.craft()", () => {
	...
	test("given sufficient inventory, recipe is crafted", () => {
		const inventory: ItemStack[] = [
			new ItemStack(new Ingredient("Apple", CategoryType.FRUIT), 10),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT), 1),
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT), 20),
		];

		const strawBerryBananaPopsicle = new Recipe("Strawberry Banana Popsicle", [
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT), 3),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT), 1),
		]);
	...
	test("given insufficient inventory the recipe is not crafted", () => {
		...
		const strawBerryBananaPopsicle = new Recipe("Strawberry Banana Popsicle", [
			new ItemStack(new Ingredient("Strawberry", CategoryType.FRUIT), 3),
			new ItemStack(new Ingredient("Banana", CategoryType.FRUIT), 3),
		]);
